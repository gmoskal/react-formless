import { toFormState, toResult, validateForm, InputState } from "./forms"
import { Ok } from "./utils/validators"
    ...
    describe("validateForm()", () => {
        it("touches all on flat form", () => {
            ...
            const expectedState: FormState<N> = {
                n: { visited: true, active: false, value: "User", validationResult: Ok("User") }
            }
        ...
        it("touches all on chips form", () => {
            ...
            const expectedState: FormState<Bag> = {
                items: {
                    ...
                    active: false,
                    value: ["item", "item2"],
                    validationResult: Ok(["item", "item2"])
                }
            }
                ...
                items: [
                    {
                        ...
                        active: false,
                        value: "item",
                        validationResult: Ok("item")
                    },
                    {
                        visited: true,
                        active: false,
                        value: "item2",
                        validationResult: Ok("item2")
                    }
                ]
            }
        ...
        it("touches all on nasted form", () => {
            ...
            const expectedState: FormState<User> = {
                name: { visited: true, active: false, value: "User", validationResult: Ok("User") },
                skills: [
                    {
                        name: { visited: true, active: false, value: "datomic", validationResult: Ok("datomic") },
                        level: { visited: true, active: false, value: 1, validationResult: Ok(1) }
                    },
                    {
                        name: { visited: true, active: false, value: "react", validationResult: Ok("react") },
                        level: { visited: true, active: false, value: 10, validationResult: Ok(10) }
                    }
                ]
            }
